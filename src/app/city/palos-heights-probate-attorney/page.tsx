...
export default function PalosHeightsProbatePage() {
  const attorneys = getAttorneysByCity("Palos Heights");
      ...
      <section className="bg-gradient-to-r from-navy-800 to-navy-700 text-white py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold mb-3">
            Probate Attorneys in Palos Heights, Illinois
          </h1>
          <p className="text-gray-200 max-w-2xl leading-relaxed">
            Palos Heights is a southwest suburban Cook County community. Probate
            cases for Palos Heights residents are filed at the Richard J. Daley
            Center in Chicago. Attorneys here serve Palos Heights, Palos Hills,
            Orland Park, and surrounding southwest Cook County communities.
          </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="flex-1 min-w-0">
            <h2 className="font-serif font-bold text-navy-800 text-xl mb-6">
              {attorneys.length} Probate Attorneys in Palos Heights
            </h2>
          ...
          <aside className="lg:w-64 shrink-0 space-y-6">
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                All Cook County probate cases are filed here, including estates
                from Palos Heights, Palos Hills, Orland Park, and surrounding
                southwest suburbs.
              </p>
            </div>
