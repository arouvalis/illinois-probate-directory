...
export default function LibertyvilleProbatePage() {
  const attorneys = getAttorneysByCity("Libertyville");
      ...
      <section className="bg-gradient-to-r from-navy-800 to-navy-700 text-white py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-blue-300 mb-3">
            ...
            <span>/</span>
            <Link href="/county/lake-county" className="hover:text-white transition-colors">Lake County</Link>
            <span>/</span>
            <span>Libertyville</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-serif font-bold mb-3">
            Probate Attorneys in Libertyville, Illinois
          </h1>
          <p className="text-gray-200 max-w-2xl leading-relaxed">
            Libertyville is a prominent Lake County community in the northern
            Chicago suburbs. Probate cases for Libertyville residents are filed
            at the Lake County Courthouse in Waukegan. Attorneys here serve
            Libertyville, Mundelein, Vernon Hills, and surrounding Lake County
            communities.
          </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="flex-1 min-w-0">
            <h2 className="font-serif font-bold text-navy-800 text-xl mb-6">
              {attorneys.length} Probate Attorneys in Libertyville
            </h2>
          ...
          <aside className="lg:w-64 shrink-0 space-y-6">
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                All Lake County probate cases are filed here, including estates
                from Libertyville, Mundelein, Vernon Hills, and Lake Forest.
              </p>
            </div>
