...
export default function ElginProbatePage() {
  const attorneys = getAttorneysByCity("Elgin");
      ...
      <section className="bg-gradient-to-r from-navy-800 to-navy-700 text-white py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-200 max-w-2xl leading-relaxed">
            Elgin is one of the largest cities in Kane County. Probate cases for
            Elgin residents are filed at the Kane County Courthouse in Geneva.
            Attorneys here serve Elgin, South Elgin, Streamwood, and surrounding
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="flex-1 min-w-0">
            <h2 className="font-serif font-bold text-navy-800 text-xl mb-6">
              {attorneys.length} Probate Attorneys in Elgin
            </h2>
          ...
          <aside className="lg:w-64 shrink-0 space-y-6">
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                All Kane County probate cases are filed here, including estates
                from Elgin, Aurora, St. Charles, and Batavia.
              </p>
            </div>
