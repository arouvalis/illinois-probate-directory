...
export default function OrlandParkProbatePage() {
  const attorneys = getAttorneysByCity("Orland Park");
      ...
      <section className="bg-gradient-to-r from-navy-800 to-navy-700 text-white py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold mb-3">
            Probate Attorneys in Orland Park, Illinois
          </h1>
          <p className="text-gray-200 max-w-2xl leading-relaxed">
            Orland Park is a southwest suburban Cook County community. Probate cases
            for Orland Park residents are filed at the Richard J. Daley Center in
            Chicago. Attorneys here serve Orland Park, Tinley Park, Mokena, and
            surrounding southwest suburbs.
          </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="font-serif font-bold text-navy-800 text-xl mb-6">
              {attorneys.length} Probate Attorneys in Orland Park
            </h2>
          ...
          <aside className="lg:w-64 shrink-0 space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                ...
                from Orland Park, Tinley Park, Mokena, and surrounding suburbs.
              </p>
            </div>
