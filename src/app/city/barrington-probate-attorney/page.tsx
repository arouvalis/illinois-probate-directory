...
export default function BarringtonProbatePage() {
  const attorneys = getAttorneysByCity("Barrington");
      ...
      <section className="bg-gradient-to-r from-navy-800 to-navy-700 text-white py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-blue-300 mb-3">
            ...
            <span>/</span>
            <Link href="/county/cook-county" className="hover:text-white transition-colors">Cook County</Link>
            <span>/</span>
            <span>Barrington</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-serif font-bold mb-3">
            Probate Attorneys in Barrington, Illinois
          </h1>
          <p className="text-gray-200 max-w-2xl leading-relaxed">
            Barrington is a northwest suburban community that sits at the intersection
            of Cook, Lake, McHenry, and Kane counties. Most Barrington probate cases
            are filed at the Richard J. Daley Center in Chicago. Attorneys here serve
            Barrington, South Barrington, Inverness, and surrounding communities.
          </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="flex-1 min-w-0">
            <h2 className="font-serif font-bold text-navy-800 text-xl mb-6">
              {attorneys.length} Probate Attorneys in Barrington
            </h2>
          ...
          <aside className="lg:w-64 shrink-0 space-y-6">
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Most Barrington probate cases are filed here. Verify your county
                with your attorney as Barrington spans multiple county lines.
              </p>
            </div>
